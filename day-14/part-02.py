...
class Grid:
    ...
    def build(self, lines):
        ...
        self.add_wall((0, self.r_max + 2), (1000, self.r_max + 2))
    ...
    def is_blocked(self):
        return self.grid[500][0] != '.'

    def drop_sand(self, c, r):
        "Drops a unit of sand, returns True if it comes to rest, False if the source is blocked."
